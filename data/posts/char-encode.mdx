...
1. 举个开发中可能遇到的字符编码相关的概念，`content-type`

```text
// Content-Type 实体头部用于指示资源的 MIME 类型media type 。在响应中，Content-Type 标头告诉客户端实际返回的内容的内容类型。浏览器会在某些情况下进行 MIME 查找，并不一定遵循此标题的值;
Content-Type: text/html; charset=utf-8
```

1. 服务端在数据库存储也需要考虑编码问题 e.g. 比如在商店，就需要考虑字段存储使用 utf8 还是 utf8mb4

<Callout icon="💡" title="回头过来阅读">
...
![Untitled](https://prod-files-secure.s3.us-west-2.amazonaws.com/60e2856f-61e9-43dd-9bc7-dcb628f8fab0/0fd9343c-9e2b-49f0-8b6b-53489edbb691/Untitled.png)
...
![Untitled](https://prod-files-secure.s3.us-west-2.amazonaws.com/60e2856f-61e9-43dd-9bc7-dcb628f8fab0/1dd605ff-a648-4c3b-9f0a-745294fa2d09/Untitled.png)
...
![Untitled](https://prod-files-secure.s3.us-west-2.amazonaws.com/60e2856f-61e9-43dd-9bc7-dcb628f8fab0/44ade438-a79a-4500-86a5-9648786eb33b/Untitled.png)
...
![Untitled](https://prod-files-secure.s3.us-west-2.amazonaws.com/60e2856f-61e9-43dd-9bc7-dcb628f8fab0/7774fb15-382b-47e0-841b-de2b4995f316/Untitled.png)
...
![Untitled](https://prod-files-secure.s3.us-west-2.amazonaws.com/60e2856f-61e9-43dd-9bc7-dcb628f8fab0/f927128a-40c0-461b-9c4a-e6c4c24a07a0/Untitled.png)
...
![Untitled](https://prod-files-secure.s3.us-west-2.amazonaws.com/60e2856f-61e9-43dd-9bc7-dcb628f8fab0/30beb57c-3655-4e4c-9b62-c126fb1f2558/Untitled.png)
...
- [Unicode 与 Javascript 详解](https://www.ruanyifeng.com/blog/2014/12/unicode.html)
    ...
    [](https://xiaomi.f.mioffice.cn/space/api/box/stream/download/asynccode/?code=MTA1ZmJjZDUyMmQ2NjYwNGNlZTIxZWUwYmE4OGVkZmFfRmtlT0ZIQ3UxZk9GOTlOMm9HVmJaeGQ0R2R4VHBkZmVfVG9rZW46Ym94azR6NGZnZVBNb2U2S2FnUGNpV2toZDFkXzE2OTkyNzIyMzQ6MTY5OTI3NTgzNF9WNA)
